...
class CoverageProcessor:
    ...
    def parse_coverage_report_cobertura(self, filename: str = None) -> Union[Tuple[list, list, float], dict]:
        ...
        Returns:
            Union[Tuple[list, list, float], dict]: If filename is provided, returns a tuple containing lists of covered and missed line numbers, 
                                                and the coverage percentage. If filename is None, returns a dictionary with filenames as 
                                                keys and a tuple containing lists of covered and missed line numbers, 
